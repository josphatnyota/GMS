...
$memid=$_POST['memid'];
$email=$_POST['email'];
$sql ="SELECT MemberId,EmailId,Status FROM tblmembers WHERE MemberId=:memid and EmailId=:email";
                ...
                <div class="p-5">
				  ...
				  <div class="text-center">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="memid" id="exampleInputText" aria-describedby="emailHelp" placeholder="National ID">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="email" id="exampleInputText" aria-describedby="emailHelp" placeholder="Email">
                    </div>
