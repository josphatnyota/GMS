...
<button type="submit" name="uploadmemberimage"  id="upload" class="btn btn-primary">UPLOAD</button>
</form></div>
...
<tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostalTown);?></td>
                                             <td style="font-size:16px;">Country</td>
                                            <td><?php echo htmlentities($result->PostalCountry);?></td>
</tr>
...
{         
  ...
  <tr>
                                              <td style="font-size:16px;">Service</td> 
