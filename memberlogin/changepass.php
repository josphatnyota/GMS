...
$status=2;
    $sql ="update tblmembers set Password=:password,Status=:status WHERE MemberId=:username";
...
header('location:memberdetails.php?success');
                ...
                <div class="p-5">
				  ...
				  <div class="text-center">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control" name="password"id="exampleInputPassword" placeholder="New Password" required>
                    </div>
                      <div class="form-group">
                      
                    </div>
                      
                 <input name="change" type="submit" value="Change Password"class="btn btn-primary btn-user btn-block">
