...
$sql="INSERT INTO tblgroups(Name,Role,InstitutionID) VALUES(:groupname,:grouprole,:iid)";
      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-left">
                <h1 class="h4 text-gray-900 mb-4">Add New Group</h1>
              </div>
			   ...
			   <?php if($error){?><div class=" alert alert-danger "><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
				...
				<div class="form-group row">
				  ...
				  <label for="groupname">Group Name</label>
                    <input type="text" class="form-control form-control" name="groupname" id="groupname" placeholder="Group Name" required>
              
				  </div>
				  </div>
				  <div class="form-group row">
                  <div class="col-sm-6 ">
				  <label for="grouprole">Role</label>
                    <textarea type="text" class="form-control form-control"  name="grouprole" id="grouprole" Value="Role" required>
                  </textarea>
				  </div>
                </div>
