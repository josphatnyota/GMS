...
CommitteeName,Position,StartServing,EndServing,GroupName,GroupPosition FROM tblmembers where InstitutionID=$iid and GroupName='$cid'";
...
header('Content-Disposition: attachment; filename=GroupDetails.csv');
