...
CommitteeName,Position,StartServing,EndServing,GroupName,GroupPosition FROM tblmembers where InstitutionID=$iid and CommitteeName='$cid'";
...
header('Content-Disposition: attachment; filename=CommitteeDetails.csv');
...
'Position','Start Serving','End Serving','Group Name','Group Position'));
