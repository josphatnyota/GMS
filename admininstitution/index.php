...
$sql ="SELECT UserID,Password,Status FROM tblinstitution WHERE UserID=:uname and Password=:password";
...
$_SESSION['ilogin']=$_POST['username'];
 echo "<script type='text/javascript'> document.location = 'setcode.php'; </script>";
}else if ($status ==2){
$_SESSION['ilogin']=$_POST['username'];
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">GMS Institution Admin</h1>
                  </div>
