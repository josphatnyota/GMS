			   ...
			   <?php if($error){?><div class=" alert alert-danger "><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
                ...
                <div class="form-group row">
				  ...
				  <label for="firstname">First Name </label>
                    <input type="text" class="form-control form-control" name="firstname" id="firstname" placeholder="first name" required>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
				  <label for="lastname">Surname Name</label>
                    <input type="text" class="form-control form-control"  name="lastname" id="lastname" placeholder="Surname Name" required>
                  </div>
				  <div class="col-sm-6">
				  <label for="emailid">Email</label>
                  <input type="email" class="form-control form-control"  name="emailid" id="emailid" placeholder="email id" required>
                </div>
                </div>
                <div class="form-group row">
				  ...
				  <label for="memberid">Member ID</label>
                    <input type="text" class="form-control form-control"  name="memberid" id="memberid" placeholder="memberid" required>
                  </div>
				  <div class="col-sm-6">
				 <label for="phonenumber">Phone Number</label>
                    <input type="text" class="form-control form-control"  name="phonenumber" id="phonenumber" placeholder="Contact" required>
                 </div>
                </div>
                <div class="form-group row">
                ...
                <option value="Intersex">Intersex</value>
				  ...
				  <label for="dob">Date of Birth</label>
                    <input type="date" class="form-control form-control"  name="dob" id="dob" placeholder="Date of birth" required>
                ...
                <div class="form-group row">
				  ...
				  <label for="natureofwork">Nature Of Work</label>
                    <select class="form-control form-control custom-select"  name="natureofwork" id="natureofwork" placeholder="Nature Of Work" required>
                  ...
                  <input type="text" class="form-control form-control"  name="businessname" id="businessname" placeholder="Business Name" required>
                </div>				  
				  </div> 
                <div class="form-group row">
				  ...
				  <label for="employer">Employer</label>
                    <input class="form-control form-control "  name="employer" id="employer" placeholder="Employer" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="rank">Rank/Position</label>
                  <input type="text" class="form-control form-control" name="rank" id="rank" placeholder="Rank" required>
                </div>				  
				  </div>
                <div class="form-group row">
				  ...
				  <label for="workbuilding">Work Building</label>
                    <input class="form-control form-control "  name="workbuilding" id="workbuilding" placeholder=" Building" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="workroad">Road</label>
                    <input class="form-control form-control "  name="workroad" id="workroad" placeholder="Road" required>
                      </div>				  
				  </div>
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control form-control"  name="worktown" id="worktown" placeholder="Town" required>
                
				 </div>
				  <div class="col-sm-6">
				  <label for="workcounty">County</label>
                    <input class="form-control form-control "  name="workcounty" id="workcounty" placeholder="County" required>
                      </div>				  
				  </div>
                <div class="form-group row">
				  ...
				  <label for="workcountry">Country</label>
                    <input class="form-control form-control " name="workcountry" id="workcountry" placeholder="Country" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="workpostaladdress">Address</label>
                  <input type="text" class="form-control form-control"  name="workpostaladdress" id="workpostaladdress" placeholder="Address" required>
                </div>				  
				  </div>
                <div class="form-group row">
				  ...
				  <label for="workpostalcode">Code</label>
                    <input class="form-control form-control "  name="workpostalcode" id="workpostalcode" placeholder="Code" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="workpostaltown">Town</label>
                  <input type="text" class="form-control form-control"  name="workpostaltown" id="workpostaltown" placeholder="Town" required>
                </div>				  
				  </div>
                <div class="form-group row">
				  ...
				  <label for="workpostalcounty">County</label>
                    <input class="form-control form-control "  name="workpostalcounty" id="workpostalcounty" placeholder="County" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="workpostalcountry">Country</label>
                  <input type="text" class="form-control form-control"  name="workpostalcountry" id="workpostalcountry" placeholder="Country" required>
                </div>				  
				  </div>				 
                ...
                <div class="form-group row">
				  ...
				  <label for="workemail">Email</label>
                    <input type="email" class="form-control form-control " name="workemail" id="workemail" placeholder="Email" required>
                      
				 </div>
				  <div class="col-sm-6">
				  <label for="workmobileno">Mobile</label>
                  <input type="text" class="form-control form-control" name="workmobileno" id="workmobileno" placeholder="Mobile" required>
                </div>				  
				  </div>
                <div class="form-group row">
				  ...
				  <label for="workotherno">Telephone</label>
                    <input class="form-control form-control " name="workotherno" id="workotherno" placeholder="Telephone" required>
                      
				 </div>			  
				  </div>
					
				<div style=" padding-left:50%;">
                <input  name="update" type="submit" id="update" value="Add" class="btn btn-primary ">
                 </div>
