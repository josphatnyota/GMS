...
$username=$_SESSION['ilogin'];
    $sql ="SELECT Password FROM tblinstitution WHERE UserID=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblinstitution set Password=:newpassword where UserID=:username";
