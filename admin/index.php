...
$sql ="SELECT username,password,Status FROM admin WHERE username=:uname and password=:password";
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">GMS Admin</h1>
                  </div>
